...
class c_interop_string(c_char_p):
    def __init__(self, p: Incomplete | None = ...) -> None: ...
    @property
    def value(self): ...
    @classmethod
...
class _CXString(Structure):
    ...
    @staticmethod
    def from_result(res, fn: Incomplete | None = ...,
...
class Diagnostic:
    ...
    def format(self, options: Incomplete | None = ...): ...
    def from_param(self): ...
...
class Cursor(Structure):
    ...
    @staticmethod
    def from_result(res: Cursor, fn, args) -> None | Cursor: ...
    @staticmethod
    def from_cursor_result(res: Cursor, fn, args) -> None | Cursor: ...
...
class Type(Structure):
    ...
    def translation_unit(self) -> TranslationUnit: ...
    @staticmethod
    def from_result(res: Type, fn, args) -> None | Type: ...
    def get_num_template_arguments(self) -> int: ...
...
class Index(ClangObject):
    ...
    def parse(self, path: str, args: list[str] | None = ...,
              unsaved_files: list[(str, str)] | None = ..., options: int = ...) -> 'TranslationUnit': ...
...
class TranslationUnit(ClangObject):
    ...
    @classmethod
    def from_source(cls, filename: str, args: list[str] | None = ..., unsaved_files: list[(str, str)] |
                    None = ..., options: int = ..., index: Index | None = ...): ...

    @classmethod
    def from_ast_file(cls, filename: str, index: Index | None = ...): ...
    index: Index
    ...
    @property
    def spelling(self) -> str: ...
    def get_includes(self) -> list[FileInclusion]: ...
    def get_file(self, filename: str) -> File: ...

    def get_location(self, filename: str, position: (
        int, int)) -> SourceLocation: ...
    def get_extent(self, filename: str,
                   locations: list[(int, int)]) -> SourceRange: ...
    tu: TranslationUnit
    @property
    def diagnostics(self) -> list[Diagnostic]: ...
    def reparse(self, unsaved_files: [(str, str)] |
                None = ..., options: int = ...) -> None: ...

    def save(self, filename: str) -> None: ...

    def codeComplete(self, path: str, line: int, column: int, unsaved_files: list[(str, str)] | None = ...,
                     include_macros: bool = ..., include_code_patterns: bool = ..., include_brief_comments: bool = ...) -> CodeCompletionResults | None: ...
    def get_tokens(self, locations: list[(int, int)] | None = ...,
                   extent: SourceRange | None = ...) -> list[Token]: ...


class File(ClangObject):
    @staticmethod
    def from_name(translation_unit: TranslationUnit, file_name: str): ...
    @property
    def name(self) -> str: ...
    @property
    def time(self) -> int: ...
